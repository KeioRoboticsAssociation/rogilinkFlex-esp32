...
// コンストラクタ
CommunicationBase::CommunicationBase(uint8_t device_id)
{
    // デバイスIDを設定
...
// コンストラクタ
CobsEncodedCommunicationBase::CobsEncodedCommunicationBase(uint8_t device_id)
 : CommunicationBase(device_id) 
{
