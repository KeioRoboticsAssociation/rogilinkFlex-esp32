...
// // コンストラクタ
// CanLink::CanLink(PinName rd_pin, PinName td_pin, int frequency, EventQueue* queue)
//  : CommunicationBase(nullptr), can(rd_pin, td_pin), canlink_queue(queue) // コンストラクタでCANクラスを初期化する。イベントキューはCanLinkクラスで管理するためnullptrを渡す
// {
